  ...
  class Box extends React.Component {
    ...
    render() {
      ...
      if (this.props.letter) {  
        input = <input id={`input${this.props.id}`} value={this.showData && this.props.letter} type="text" maxLength="1" className={ `box-input ${this.state.highlight ? 'highlight' : ''}` } onFocus={ this.handleFocus } ref={(input) => { this.textInput = input }} />
      }
